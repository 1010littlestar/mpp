...
#define PIRIS_A_CFG_REG0(dev)        HI_IO_PIRISI_ADDRESS(dev, PIRISI_ADRESS_BASE + 0x0140)
#define PIRIS_A_CTRL_REG0(dev)       HI_IO_PIRISI_ADDRESS(dev, PIRISI_ADRESS_BASE + 0x0400)

#define PIRIS_B_CFG_REG0(dev)        HI_IO_PIRISI_ADDRESS(dev, PIRISI_ADRESS_BASE + 0x1280)
#define PIRIS_B_CTRL_REG0(dev)       HI_IO_PIRISI_ADDRESS(dev, PIRISI_ADRESS_BASE + 0x1400)
...
int PIRIS_DRV_Write(int dev, unsigned char bits)
{
    switch (bits) {
        case 0:
            PIRIS_WRITE_REG(PIRIS_A_CTRL_REG0(dev), 0x50);
            PIRIS_WRITE_REG(PIRIS_B_CTRL_REG0(dev), 0xA0);
