...
int imx290_write_register(VI_PIPE ViPipe, int addr, int data)
{
    if (g_fd[ViPipe] < 0) {
        return HI_SUCCESS;
    }
...
void imx290_prog(VI_PIPE ViPipe, int *rom)
{
    int i = 0;
    while (1) {
        int lookup = rom[i++];
        ...
        if (addr == 0xFFFE) {
            ...
            imx290_write_register(ViPipe, addr, data);
        }
    }
}
...
void imx290_default_reg_init(VI_PIPE ViPipe)
{
    ...
    for (i = 0; i < g_pastImx290[ViPipe]->astRegsInfo[0].u32RegNum; i++) {
        imx290_write_register(ViPipe, g_pastImx290[ViPipe]->astRegsInfo[0].astI2cData[i].u32RegAddr, g_pastImx290[ViPipe]->astRegsInfo[0].astI2cData[i].u32Data);
    }
}
...
void imx290_init(VI_PIPE ViPipe)
{
    ...
    bInit       = g_pastImx290[ViPipe]->bInit;
    ...
    if (bInit == HI_FALSE) {
        if (WDR_MODE_2To1_LINE == enWDRMode) {
            if (IMX290_SENSOR_1080P_30FPS_2t1_WDR_MODE == u8ImgMode) {  /* IMX290_SENSOR_1080P_30FPS_2t1_WDR_MODE */
                imx290_wdr_1080p60_2to1_init(ViPipe);
            } else if (IMX290_SENSOR_720P_30FPS_2t1_WDR_MODE == u8ImgMode) { /* IMX290_SENSOR_720P_30FPS_2t1_WDR_MODE */
                imx290_wdr_720p60_2to1_init(ViPipe);
            } else {
            }
        } else if (WDR_MODE_3To1_LINE == enWDRMode) {
            imx290_wdr_1080p120_3to1_init(ViPipe);
        } else {
    ...
    g_pastImx290[ViPipe]->bInit = HI_TRUE;
    return;
}
...
void imx290_wdr_1080p30_3to1_init(VI_PIPE ViPipe)
{
    ...
    // 12bit
    imx290_write_register(ViPipe, 0x3007, 0x00);
    imx290_write_register(ViPipe, 0x300c, 0x21);
    imx290_write_register(ViPipe, 0x300f, 0x00);
    imx290_write_register(ViPipe, 0x3010, 0x21);
    imx290_write_register(ViPipe, 0x3012, 0x64);
    imx290_write_register(ViPipe, 0x3016, 0x09);
    imx290_write_register(ViPipe, 0x3020, 0x04);
    imx290_write_register(ViPipe, 0x3021, 0x00);
    imx290_write_register(ViPipe, 0x3024, 0xF2);
    imx290_write_register(ViPipe, 0x3025, 0x01);
    imx290_write_register(ViPipe, 0x3028, 0x57);
    imx290_write_register(ViPipe, 0x3029, 0x02);
    imx290_write_register(ViPipe, 0x3030, 0xED);
    imx290_write_register(ViPipe, 0x3031, 0x01);
    imx290_write_register(ViPipe, 0x3034, 0x30);
    imx290_write_register(ViPipe, 0x3035, 0x02);
    imx290_write_register(ViPipe, 0x3045, 0x05);
    imx290_write_register(ViPipe, 0x304b, 0x0a);
    imx290_write_register(ViPipe, 0x305c, 0x18);
    imx290_write_register(ViPipe, 0x305d, 0x03);
    ...
    imx290_write_register(ViPipe, 0x30ac, 0x20);
    imx290_write_register(ViPipe, 0x30b0, 0x43);
    imx290_write_register(ViPipe, 0x3106, 0x33);
    imx290_write_register(ViPipe, 0x3119, 0x9e);
    imx290_write_register(ViPipe, 0x311c, 0x1e);
    imx290_write_register(ViPipe, 0x311e, 0x08);
    imx290_write_register(ViPipe, 0x3128, 0x05);
    ...
    imx290_write_register(ViPipe, 0x3418, 0x24);  /* Y_OUT_SIZE */
    imx290_write_register(ViPipe, 0x3419, 0x0F);
...
void imx290_wdr_720p60_3to1_init(VI_PIPE ViPipe)
{
    ...
    imx290_write_register(ViPipe, 0x3009, 0x01);
    imx290_write_register(ViPipe, 0x300a, 0xf0);
    imx290_write_register(ViPipe, 0x300c, 0x31);
    imx290_write_register(ViPipe, 0x300f, 0x00);
    imx290_write_register(ViPipe, 0x3010, 0x21);
    imx290_write_register(ViPipe, 0x3012, 0x64);
    imx290_write_register(ViPipe, 0x3016, 0x09);
    ...
    imx290_write_register(ViPipe, 0x3407, 0x03);
    imx290_write_register(ViPipe, 0x3414, 0x04);
    imx290_write_register(ViPipe, 0x3418, 0xb5);
    imx290_write_register(ViPipe, 0x3419, 0x08);
    imx290_write_register(ViPipe, 0x3441, 0x0c);
    imx290_write_register(ViPipe, 0x3442, 0x0c);
    imx290_write_register(ViPipe, 0x3443, 0x03);
...
void imx290_wdr_1080p120_3to1_init(VI_PIPE ViPipe)
{
    ...
    imx290_write_register(ViPipe, 0x3018, 0x65);
    imx290_write_register(ViPipe, 0x3019, 0x04);
    imx290_write_register(ViPipe, 0x301c, 0x4c);
    imx290_write_register(ViPipe, 0x301d, 0x04);

#if 1
    imx290_write_register(ViPipe, 0x3020, 0x04);  /* SHS1 */
    imx290_write_register(ViPipe, 0x3021, 0x00);
    imx290_write_register(ViPipe, 0x3024, 0xf2);  /* SHS2 */
    imx290_write_register(ViPipe, 0x3025, 0x01);
    imx290_write_register(ViPipe, 0x3028, 0x57);  /* SHS3 */
    imx290_write_register(ViPipe, 0x3029, 0x02);
    imx290_write_register(ViPipe, 0x3030, 0xed);  /* RHS1 */
    imx290_write_register(ViPipe, 0x3031, 0x01);
    imx290_write_register(ViPipe, 0x3034, 0x30);  /* RHS2 */
    imx290_write_register(ViPipe, 0x3035, 0x02);
#else
    imx290_write_register(ViPipe, 0x3020, 0x04);
    imx290_write_register(ViPipe, 0x3024, 0x89);
    imx290_write_register(ViPipe, 0x3028, 0x93);
    imx290_write_register(ViPipe, 0x3029, 0x01);
    imx290_write_register(ViPipe, 0x3030, 0x85);
    imx290_write_register(ViPipe, 0x3034, 0x92);
#endif
    ...
    imx290_write_register(ViPipe, 0x3407, 0x03);
    imx290_write_register(ViPipe, 0x3414, 0x0a);
    imx290_write_register(ViPipe, 0x3418, 0x55);
    imx290_write_register(ViPipe, 0x3419, 0x11);
    imx290_write_register(ViPipe, 0x3441, 0x0a);
    imx290_write_register(ViPipe, 0x3442, 0x0a);
    imx290_write_register(ViPipe, 0x3443, 0x03);
    imx290_write_register(ViPipe, 0x3444, 0x20);
