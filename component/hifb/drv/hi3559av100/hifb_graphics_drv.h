...
#define GFX_SPIN_LOCK_FLAG        HI_UL
...
typedef struct hiVOU_GFXLAYER_CONTEXT_S {
...
HI_BOOL GRAPHIC_DRV_SetGfxPalpha(HAL_DISP_LAYER_E enLayer, HI_U32 bAlphaEn, HI_U32 bArange, HI_U8 u8Alpha0,
                                 HI_U8 u8Alpha1);
...
HI_BOOL GRAPHIC_DRV_EnableGHDR(HAL_DISP_LAYER_E enLayer, HI_BOOL bEnable);
