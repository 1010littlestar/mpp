...
HI_S32 FISHEYE_Calibrate_MapVirtAddr( VIDEO_FRAME_INFO_S* pstFrame)
{
    ...
    pstFrame->stVFrame.u64VirAddr[0] = (HI_U64) HI_MPI_SYS_MmapCache(phy_addr, size);
...
HI_VOID FISHEYE_Calibrate_SaveSP42XToPlanar(FILE* pfile, VIDEO_FRAME_S* pVBuf)
{
    ...
    pVBufVirt_Y = (char*)pVBuf->u64VirAddr[0];
                                    ...
                                    VB_BLK* pstVbBlk, VB_POOL pool)
{
    ...
    *pstVbBlk = VbBlk;
    ...
    u64VirAddr = (HI_U64) HI_MPI_SYS_Mmap(u64PhyAddr, u32Size);
...
END5:
    ...
    HI_MPI_SYS_Munmap((HI_VOID*)stVFramOut.stVFrame.u64VirAddr[0], u32BlkSize);
